...
interface IAccessControlUpgradeableInterface extends utils.Interface {
    contractName: string | "IAccessControlUpgradeable";
    functions: {
...
export { IAccessControlUpgradeable, IAccessControlUpgradeableInterface, RoleAdminChangedEvent, RoleAdminChangedEventFilter, RoleGrantedEvent, RoleGrantedEventFilter, RoleRevokedEvent, RoleRevokedEventFilter };
