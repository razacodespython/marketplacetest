...
interface IGovernorUpgradeableInterface extends utils.Interface {
    contractName: string | "IGovernorUpgradeable";
    functions: {
...
interface IGovernorUpgradeable extends BaseContract {
    contractName: string | "IGovernorUpgradeable";
...
export { IGovernorUpgradeable, IGovernorUpgradeableInterface, ProposalCanceledEvent, ProposalCanceledEventFilter, ProposalCreatedEvent, ProposalCreatedEventFilter, ProposalExecutedEvent, ProposalExecutedEventFilter, VoteCastEvent, VoteCastEventFilter };
