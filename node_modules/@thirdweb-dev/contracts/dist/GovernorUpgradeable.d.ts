...
interface GovernorUpgradeableInterface extends utils.Interface {
    contractName: string | "GovernorUpgradeable";
    functions: {
...
interface GovernorUpgradeable extends BaseContract {
    contractName: string | "GovernorUpgradeable";
...
export { GovernorUpgradeable, GovernorUpgradeableInterface, ProposalCanceledEvent, ProposalCanceledEventFilter, ProposalCreatedEvent, ProposalCreatedEventFilter, ProposalExecutedEvent, ProposalExecutedEventFilter, VoteCastEvent, VoteCastEventFilter };
