...
interface IERC1155MetadataURIUpgradeableInterface extends utils.Interface {
    contractName: string | "IERC1155MetadataURIUpgradeable";
    functions: {
...
interface IERC1155MetadataURIUpgradeable extends BaseContract {
    contractName: string | "IERC1155MetadataURIUpgradeable";
...
export { ApprovalForAllEvent, ApprovalForAllEventFilter, IERC1155MetadataURIUpgradeable, IERC1155MetadataURIUpgradeableInterface, TransferBatchEvent, TransferBatchEventFilter, TransferSingleEvent, TransferSingleEventFilter, URIEvent, URIEventFilter };
