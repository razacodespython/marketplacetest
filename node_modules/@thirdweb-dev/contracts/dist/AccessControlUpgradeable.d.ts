...
interface AccessControlUpgradeableInterface extends utils.Interface {
    contractName: string | "AccessControlUpgradeable";
    functions: {
...
export { AccessControlUpgradeable, AccessControlUpgradeableInterface, RoleAdminChangedEvent, RoleAdminChangedEventFilter, RoleGrantedEvent, RoleGrantedEventFilter, RoleRevokedEvent, RoleRevokedEventFilter };
