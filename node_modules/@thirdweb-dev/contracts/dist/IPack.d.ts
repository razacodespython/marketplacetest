...
interface IPackInterface extends utils.Interface {
    contractName: string | "IPack";
    functions: {
...
interface IPack extends BaseContract {
    contractName: string | "IPack";
...
export { DefaultRoyaltyEvent, DefaultRoyaltyEventFilter, IPack, IPackInterface, RoyaltyForTokenEvent, RoyaltyForTokenEventFilter };
