import { utils, BigNumberish, BytesLike, BigNumber, BaseContract, Signer, Overrides, ContractTransaction, CallOverrides, PopulatedTransaction } from 'ethers';
...
interface IERC721EnumerableUpgradeableInterface extends utils.Interface {
    contractName: string | "IERC721EnumerableUpgradeable";
    functions: {
...
interface IERC721EnumerableUpgradeable extends BaseContract {
    contractName: string | "IERC721EnumerableUpgradeable";
...
export { ApprovalEvent, ApprovalEventFilter, ApprovalForAllEvent, ApprovalForAllEventFilter, IERC721EnumerableUpgradeable, IERC721EnumerableUpgradeableInterface, TransferEvent, TransferEventFilter };
