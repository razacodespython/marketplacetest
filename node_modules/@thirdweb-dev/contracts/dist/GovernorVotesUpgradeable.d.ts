...
interface GovernorVotesUpgradeableInterface extends utils.Interface {
    contractName: string | "GovernorVotesUpgradeable";
    functions: {
...
interface GovernorVotesUpgradeable extends BaseContract {
    contractName: string | "GovernorVotesUpgradeable";
...
export { GovernorVotesUpgradeable, GovernorVotesUpgradeableInterface, ProposalCanceledEvent, ProposalCanceledEventFilter, ProposalCreatedEvent, ProposalCreatedEventFilter, ProposalExecutedEvent, ProposalExecutedEventFilter, VoteCastEvent, VoteCastEventFilter };
