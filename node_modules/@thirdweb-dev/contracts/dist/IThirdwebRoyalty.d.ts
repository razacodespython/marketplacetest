...
interface IThirdwebRoyaltyInterface extends utils.Interface {
    contractName: string | "IThirdwebRoyalty";
    functions: {
...
interface IThirdwebRoyalty extends BaseContract {
    contractName: string | "IThirdwebRoyalty";
...
export { DefaultRoyaltyEvent, DefaultRoyaltyEventFilter, IThirdwebRoyalty, IThirdwebRoyaltyInterface, RoyaltyForTokenEvent, RoyaltyForTokenEventFilter };
