...
interface DropERC1155 extends BaseContract {
    ...
    functions: {
        ...
        setClaimConditions(_tokenId: BigNumberish, _phases: IDropClaimCondition.ClaimConditionStruct[], _resetLimitRestriction: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setClaimConditions(_tokenId: BigNumberish, _phases: IDropClaimCondition.ClaimConditionStruct[], _resetLimitRestriction: boolean, overrides?: CallOverrides): Promise<void>;
