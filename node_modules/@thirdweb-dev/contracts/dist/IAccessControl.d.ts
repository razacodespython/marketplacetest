...
interface IAccessControlInterface extends utils.Interface {
    contractName: string | "IAccessControl";
    functions: {
...
export { IAccessControl, IAccessControlInterface, RoleAdminChangedEvent, RoleAdminChangedEventFilter, RoleGrantedEvent, RoleGrantedEventFilter, RoleRevokedEvent, RoleRevokedEventFilter };
