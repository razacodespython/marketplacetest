...
interface AccessControlInterface extends utils.Interface {
    contractName: string | "AccessControl";
    functions: {
...
export { AccessControl, AccessControlInterface, RoleAdminChangedEvent, RoleAdminChangedEventFilter, RoleGrantedEvent, RoleGrantedEventFilter, RoleRevokedEvent, RoleRevokedEventFilter };
