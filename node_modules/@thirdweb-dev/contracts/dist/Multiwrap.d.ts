...
interface MultiwrapInterface extends utils.Interface {
...
interface Multiwrap extends BaseContract {
    contractName: string | "Multiwrap";
...
export { ApprovalForAllEvent, ApprovalForAllEventFilter, DefaultRoyaltyEvent, DefaultRoyaltyEventFilter, MultiTokenTransferLib, Multiwrap, MultiwrapInterface, OwnerUpdatedEvent, OwnerUpdatedEventFilter, RoleAdminChangedEvent, RoleAdminChangedEventFilter, RoleGrantedEvent, RoleGrantedEventFilter, RoleRevokedEvent, RoleRevokedEventFilter, RoyaltyForTokenEvent, RoyaltyForTokenEventFilter, TokensUnwrappedEvent, TokensUnwrappedEventFilter, TokensWrappedEvent, TokensWrappedEventFilter, TransferBatchEvent, TransferBatchEventFilter, TransferSingleEvent, TransferSingleEventFilter, URIEvent, URIEventFilter };
