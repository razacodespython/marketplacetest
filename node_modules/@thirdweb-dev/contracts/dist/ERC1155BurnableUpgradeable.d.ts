...
interface ERC1155BurnableUpgradeableInterface extends utils.Interface {
    contractName: string | "ERC1155BurnableUpgradeable";
    functions: {
...
interface ERC1155BurnableUpgradeable extends BaseContract {
    contractName: string | "ERC1155BurnableUpgradeable";
...
export { ApprovalForAllEvent, ApprovalForAllEventFilter, ERC1155BurnableUpgradeable, ERC1155BurnableUpgradeableInterface, TransferBatchEvent, TransferBatchEventFilter, TransferSingleEvent, TransferSingleEventFilter, URIEvent, URIEventFilter };
