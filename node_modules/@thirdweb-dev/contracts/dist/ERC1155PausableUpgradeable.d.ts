...
interface ERC1155PausableUpgradeableInterface extends utils.Interface {
    contractName: string | "ERC1155PausableUpgradeable";
    functions: {
...
interface ERC1155PausableUpgradeable extends BaseContract {
    contractName: string | "ERC1155PausableUpgradeable";
...
export { ApprovalForAllEvent, ApprovalForAllEventFilter, ERC1155PausableUpgradeable, ERC1155PausableUpgradeableInterface, PausedEvent, PausedEventFilter, TransferBatchEvent, TransferBatchEventFilter, TransferSingleEvent, TransferSingleEventFilter, URIEvent, URIEventFilter, UnpausedEvent, UnpausedEventFilter };
